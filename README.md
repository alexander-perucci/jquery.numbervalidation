...
Number Validation Plugin is a plugin for jQuery that performs validation of an HTML input number type. [Try It !](http://alexanderperucci.altervista.org/portfolio-demo/jquerynumbervalidation/index.html)
